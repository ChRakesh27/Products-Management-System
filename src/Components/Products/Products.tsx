...
// Classic product indicators
const getProductIndicator = (index: number) => {
  const colors = [
    "bg-blue-500",
    "bg-emerald-500",
    "bg-amber-500",
                    ...
                    >
                      <CardContent className="p-4">
                        <div className="flex items-start gap-3">
                          <div
                            className={`w-3 h-3 rounded-full ${getProductIndicator(
                              index
                            )} flex-shrink-0 mt-2`}
                          />
                          <div className="flex-1 min-w-0">
                            ...
                            <Badge
                              variant="outline"
                              className={`px-3 py-1 rounded-md text-xs font-medium transition-colors ${statusBadgeClass(
                                p.status
                              )}`}
                            >
